from active_stream.streaming import Streamer, Listener
from active_stream.classification import Classifier, Trainer
from active_stream.monitor import Monitor
from active_stream.text_processing import TextProcessor
from active_stream.credentials import credentials
from active_stream.annotation import Annotator
import queue
import logging
import sys
import time
...
if __name__ == '__main__':
    ...
    db = 'sdg_db'          # Mongo Database name
    collection = 'twitter_posts'           # Mongo db collection name
    ...
    streamer = Streamer(credentials_track=credentials['coll_1'],
                        credentials_sample=credentials['coll_1'],
                        data=data)
    ...
    socketio.run(app, host='localhost', port=9874, debug=True)
