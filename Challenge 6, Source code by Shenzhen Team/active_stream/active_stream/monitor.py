...
class Monitor(threading.Thread):
    ...
    def get_stats(self):
        ...
        d = self.database
        n_total = d.count_documents({'sample': 'track'})
        #n_total = d.count()

        n_sample = d.count_documents({'sample': 'sample'})
        ...
        n_annotated = d.count_documents({'manual_relevant': {'$ne': None},
                                         'sample': 'track'})
        current_clf_version = self.clf.clf_version
        n_classified = d.count_documents({'classifier_relevant': True,
